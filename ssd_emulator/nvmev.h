...
#ifdef EQUAL_IM_MEM 
#define IM_WINDOW_EXT_RATE 6
#define META_PARTITION_RATE 32
#define NPAGES_IM_MAIN(sp)	(sp.tt_pgs * IM_WINDOW_EXT_RATE)
#define NPAGES_IM_META(sp)	(sp.tt_pgs / META_PARTITION_RATE)
#define NO_TYPE_IM	7
